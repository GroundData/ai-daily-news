...
def format_handoff_context_for_agent(context: dict) -> str:
    ...
    lines = [
        ...
        "",
        "This content is not news results but context for subsequent Agent/LLM to continue processing this AI Daily News.",
        "Use this information when user says 'continue', 'write this as...', 'every day from now on...', etc.",
        "",
